<%@ Page Language="C#" MasterPageFile="~/FreePlay.Master" AutoEventWireup="true" CodeBehind="DramasPost.aspx.cs" Inherits="FreePlay.DramasPost" %>
                ...
                <div class="container">
                    ...
                    <div class="col-xl-12 mt-5">
                        ...
                        <div class="page-header bg-dark" style="padding: 11px; color: #fff;">
                            <h4>
                                <span id="txtDramaTitle" runat="server"></span>
                            </h4>
                        </div>
                        <hr />
                        <div class="row">
                            <div class="col-lg-3 text-center">
                                <asp:Image ID="DramaPosterImage" runat="server" alt="Alternate Text" class="img img-fluid" Style="width: 214px; height: 230px;" />
                            </div>
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-9">
                                        <p id="txtStoryLine" runat="server">Tincidunt integer eu augue augue nunc elit dolor, luctus placerat scelerisque euismod, iaculis eu lacus nunc mi elit, vehicula ut laoreet ac, aliquam sit amet justo nunc tempor, metus vel.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <hr />
                        <asp:Panel ID="pnlEpisodes" runat="server">
                            ...
                            <div class="movies_main text-center">
                                <asp:ListView ID="lvEpisodes" runat="server" DataKeyNames="pkDramaEpisodeID">
                                    <LayoutTemplate>
                                    ...
                                    <ItemTemplate>
                                        <!-- post -->
                                        <a href='<%#Eval("txtEpisodeEmbedLink")%>'>
                                            ...
                                            <div class="img-fluid img-container custom_trasition" style="display: inline-block; border: 1px solid #ccc; padding: 10px; margin-bottom: 1px;">
                                                ...
                                                <div class="custom_tittle_for_silder_main_div1" style="width: 130px">
                                                    <span><%#Eval("varEpisodeNumber")%></span>
                                                </div>
