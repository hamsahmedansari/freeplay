<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Admin.Master" AutoEventWireup="true" CodeBehind="MaintainUpComing.aspx.cs" Inherits="FreePlay.Administrator.MaintainUpComing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
     <title>UpComing - Administrator</title>
</asp:Content>
     ...
     <div class="container p-1">
         ...
         <div class="table-responsive">
             <div style="overflow:scroll;">
                 <asp:GridView CssClass="table" runat="server" AllowPaging="True" AutoGenerateColumns="False" ID="dgvUpComing" DataKeyNames="pkUpComingID"
                     BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" Font-Size="12px" ForeColor="Black" 
                    GridLines="Vertical" AllowSorting="false" OnPageIndexChanging="dgvUpComing_PageIndexChanging" OnRowDataBound="dgvUpComing_RowDataBound" OnSelectedIndexChanging="dgvUpComing_SelectedIndexChanging">
                    <AlternatingRowStyle BackColor="#CCCCCC" />
                    <Columns>
                        <asp:BoundField DataField="pkUpComingID" Visible="false" HeaderText="pkUpComingID" ReadOnly="true" />
                        <asp:TemplateField>
                            <ItemTemplate>
            ...
            <div class="container mt-5 bg-whiteboxshadowed pb-2">
                ...
                <div class="row">
                    <div class="col-sm-3 form-group">
                        ...
                        <asp:DropDownList runat="server" ID="txtCategory" CssClass="form-control">
                            <asp:ListItem Value="0">Select</asp:ListItem>
                            <asp:ListItem Value="1">Movie</asp:ListItem>
                            <asp:ListItem Value="2">Cartoon</asp:ListItem>
                ...
                <div class="text-center">
                    ...
                    <asp:HiddenField ID="hfUpComigID" runat="server" />
                </div>
            </div>
        </asp:Panel>
