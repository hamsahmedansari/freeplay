<%@ Page Language="C#" MasterPageFile="~/FreePlay.Master" AutoEventWireup="true" CodeBehind="Hollywood.aspx.cs" Inherits="FreePlay.Movies" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title runat="server" id="txtPageTitle">Hollywood Movies</title>
    <%--FACEBOOK--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- End -->
    <!-- Start -->
    <asp:Panel ID="pnlHollywoodMain" runat="server">
                ...
                <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12 order-md-3 custom-side-fixed-on-scroll order-sm-1 custom-side-fixed-on-scroll">
                    ...
                    <div class="" style="padding: 10px;">
                        ...
                        <div class="genres-custom-for-year-realies genres-custom">
                            ...
                            <div class="  p-4 text-center" style="padding-top: 9px !important;">
                                ...
                                <asp:ListView ID="lvMovieReleaseDate" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <a href='<%#"Hollywood.aspx?SearchBy=" + "Release Date" + "&Date=" + Eval("dteReleaseDate") %>' class="bg-dark  text-white custom-aside-reals-year">
                        ...
                        <div class="">
                            ...
                            <div class="  p-4 text-center" style="padding-top: 9px !important;">
                                <a href="Hollywood.aspx?SearchBy=HD&Quality=HD" class="bg-primary  text-white custom-aside-reals-year">HD</a>
                                <a href="Hollywood.aspx?SearchBy=Quality&Quality=Master" class="bg-danger  text-white custom-aside-reals-year">MASTER</a>
                                <a href="Hollywood.aspx?SearchBy=Quality&Quality=Cam" class="bg-success  text-white custom-aside-reals-year">CAM</a>
